...
const DICT = {
  ...
  why_3_d: { ko: "어떤 룩에도 어울리는 컬러.", en: "Clean tones for any look." },
  ...
  products_none: { ko: "해당 조건의 상품이 없습니다.", en: "No products found." },
  ...
  // Cart
  cart_title: { ko: "장바구니", en: "Cart" },
  cart_empty: { ko: "장바구니가 비어 있습니다.", en: "Your cart is empty." },
  cart_items: { ko: "상품 개수", en: "Items" },
  cart_total: { ko: "합계", en: "Total" },
  cart_checkout: { ko: "결제(준비중)", en: "Checkout (coming soon)" },
  cart_clear: { ko: "장바구니 비우기", en: "Clear Cart" },
  cart_remove: { ko: "삭제", en: "Remove" }
};
